...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    $name = $_POST['name'];
    $pass = $_POST['pass'];
    echo "your name and password saved successfully";
...
// $sql = "INSERT INTO `book` (`sno`, `name`, `age`) VALUES ('8', '$name', '$pass')";
$sql = "INSERT INTO `student` (`sno`, `name`, `password`) VALUES ('4', '$name', '$pass')";
